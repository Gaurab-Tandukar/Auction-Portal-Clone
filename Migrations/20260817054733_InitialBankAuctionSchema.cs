...
{
    /// <inheritdoc />
    public partial class InitialBankAuctionSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVerifiedForBidding = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemAttachments_AuctionItems_AuctionItemId",
                        column: x => x.AuctionItemId,
                        principalTable: "AuctionItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SavedListings_AuctionItems_AuctionItemId",
                        column: x => x.AuctionItemId,
                        principalTable: "AuctionItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuctionItems_CategoryId_Status_AuctionEndDate",
                table: "AuctionItems",
                columns: new[] { "CategoryId", "Status", "AuctionEndDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemAttachments_AuctionItemId",
                table: "ItemAttachments",
                column: "AuctionItemId");

            migrationBuilder.CreateIndex(
                name: "IX_SavedListings_AuctionItemId",
                table: "SavedListings",
                column: "AuctionItemId");

            migrationBuilder.CreateIndex(
                name: "IX_SavedListings_UserId_AuctionItemId",
                table: "SavedListings",
                columns: new[] { "UserId", "AuctionItemId" },
                unique: true);
        }
